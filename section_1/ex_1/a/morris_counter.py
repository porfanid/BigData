...
# Υλοποίηση του Morris Counter, μιας πιθανοτικής τεχνικής για προσέγγιση καταμέτρησης
# Χρησιμοποιεί μια έξυπνη στρατηγική για εκτίμηση του πλήθους στοιχείων με μικρότερη μνήμη
class MorrisCounter:
    def __init__(self):
        # Αρχικοποίηση μετρητή με τιμή 0
        # Το C χρησιμοποιείται για πιθανοτική αύξηση του μετρητή
        self.C = 0

    def insert(self):
        # Μέθοδος εισαγωγής στοιχείου με πιθανοτική λογική
